...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window=[[CPMotionRecognizingWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];//(CPMotionRecognizingWindow *)self.window;
    self.window.backgroundColor=[UIColor whiteColor];
    MasterViewController *masterctr=[[MasterViewController alloc] init];
    masterctr.managedObjectContext=self.managedObjectContext;
    UINavigationController *navigationctr=[[UINavigationController alloc] initWithRootViewController:masterctr];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSString *storeName = @"addressBook.sqlite";
